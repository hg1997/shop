        ...
        <div class="pagination">
            <s:if test="pageBean.page != 1"><%--首页+向前--%>
                <span class="firstPage"><a
                        href="${pageContext.request.contextPath}/category.action?page=1&cid=<s:property value="myCid"/>">&nbsp;</a></span>
                <span class="previousPage"><a
                        href="${pageContext.request.contextPath}/category.action?page=<s:property value='pageBean.page-1'/>&cid=<s:property value="myCid"/>">&nbsp;</a></span>
            </s:if>
            <%--分页跳转页码--%>
            <c:choose>
                <%--底部显示5个,如总页面少于5个--%>
            ...
            <c:forEach begin="${start}" end="${end}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="${pageContext.request.contextPath}/category.action?page=${i}&cid=<s:property value="myCid"/>">${i}</a>
                    </c:otherwise>
                </c:choose>
            ...
            <s:if test="pageBean.page != pageBean.totalPage"><%--向后+尾页--%>
                <a class="nextPage"
                   href="${pageContext.request.contextPath}/category.action?page=<s:property value='pageBean.page+1'/>&cid=<s:property value="myCid"/>">
                    &nbsp;</a>
                <a class="lastPage"
                   href="${pageContext.request.contextPath}/category.action?page=<s:property value='pageBean.totalPage'/>&cid=<s:property value="myCid"/>">
                    &nbsp;</a>
            </s:if>
